declare module 'lumin' {
  namespace ui {
    ...
    class UiDialog extends UiNode {
       ...
       * @param [dialogLayout=DialogLayout.kStandard] The dialog layout preference.
       ...
       * @param [imageModel=null] The dialog image model hierarchy.  Use nullptr to not show image model.
       * @param [dialogType=DialogType.kDualAction] The type of dialog.
       * @param [dialogLayout=DialogLayout.kStandard] The dialog layout preference.
       * @return New UiDialog on success; nullptr on failure.
       *
       * @priv none
       ...
       * @param [dialogType=DialogType.kDualAction] dialog type to use
       * @param [dialogLayout=DialogLayout.kWide] dialog layout to use
       * @return New UiDialog on success; nullptr on failure.
       *
       * @priv none
       */
