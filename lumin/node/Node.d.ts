declare module 'lumin' {
  ...
  class Node {
     ...
     * @param [a_bExactType=false] Flag to indicate if the child node must be the exact type or can be derived from the type (default false).
     * @param [a_bIncludeSelf=false] Flag to indicate if the search should include this Node (default false).
     ...
     * @param [a_bExactType=false] Flag to indicate if the parent node must be the exact type or can be derived from the type (default false).
     ...
     * @param [a_propagateToChildren=false] Flag to also set the visibility state of any children
     *
     * @priv none
     */
     ...
     * @param [a_propagateToChildren=false] Flag to also set the raycast state of any children
     *
     * @priv none
     */
