...
`offset?` | [number, number, number] | `default = VEC3_ZERO`<br/> - An optional offset to position the Node within the UiPortalIcon (default is [0,0,0]).  |
...
Name | Type | Description |
------ | ------ | ------ |
`scale` | number | The overall hover scale multiplier.  |
...
Name | Type | Description |
------ | ------ | ------ |
`offset` | number | The hover Z offset  |
...
Name | Type | Description |
------ | ------ | ------ |
`position` | [number, number, number] | the icon hover position.  |
...
Name | Type | Description |
------ | ------ | ------ |
`pNode` | [ModelNode](_lumin_.modelnode.md) | A pointer to the top of the Node hierarchy to use for visual representation. |
`offset?` | [number, number, number] | `default = VEC3_ZERO`<br/> - An optional offset to position the Node within the UiPortalIcon (default is [0,0,0]).  |
...
Name | Type | Description |
------ | ------ | ------ |
`mode` | [LabelDisplayMode](../enums/_lumin_.ui.labeldisplaymode.md) | the LabelDisplayMode of the portal icon label.  |
...
Name | Type | Description |
------ | ------ | ------ |
`text` | string | Text to set for the portal icon.  |
...
`labelText` | string | The UTF-8 encoded text to initially set the portal icon label to. |
`portalSize?` | [PortalIconSize](../enums/_lumin_.ui.portaliconsize.md) | `default = PortalIconSize.kSmall`<br/> - One of the built-in sizes for the portal icon (defaults to Small) |

**Returns:** *[UiPortalIcon](_lumin_.ui.uiportalicon.md)*

The new UiPortalIcon node.
