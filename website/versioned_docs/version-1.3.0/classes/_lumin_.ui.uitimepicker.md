---
id: "_lumin_.ui.uitimepicker"
title: "UiTimePicker"
sidebar_label: "UiTimePicker"
---
...
▸ **getTime**(): *[Time](_lumin_.ui.time.md)*

Gets the time as a Time object

**Returns:** *[Time](_lumin_.ui.time.md)*

the time object with values chosen from the picker
...
the time chosen from the picker
...
▸ **onTimeChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
▸ (`arg0`: [UiEventData](_lumin_.ui.uieventdata.md), `arg1`: string, `arg2`: [Time](_lumin_.ui.time.md)): *void*
...
▸ **onTimeChangedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
▸ **onTimeConfirmedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onTimeConfirmedUnsub

▸ **onTimeConfirmedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
▸ **setTime**(`newTime`: [Time](_lumin_.ui.time.md)): *boolean*
...
Name | Type | Description |
------ | ------ | ------ |
`newTime` | [Time](_lumin_.ui.time.md) | The time Sets  |
...
▸ **Create**(`volume`: [Prism](_lumin_.prism.md), `label?`: string, `labelSide?`: [Side](../enums/_lumin_.ui.side.md), `timeFormat?`: string, `defaultTime?`: [Time](_lumin_.ui.time.md)): *[UiTimePicker](_lumin_.ui.uitimepicker.md)*
...
`label?` | string | `default = ""`<br/> The text label that appears with the TimePicker. |
`labelSide?` | [Side](../enums/_lumin_.ui.side.md) | `default = Side.kTop`<br/> Boolean value specifying whether the label appears on the side or top. |
`timeFormat?` | string | `default = "hh:mm:ss"`<br/> The format for the picker time - hh:mm:ss p, hh:mm p, hh:ss p, hh:mm:ss, hh:mm, hh:ss, mm:ss.                   If the format contains a 'p' (period) the TimePicker will display hours as 1-12, otherwise hours will be displayed as 0-23. |
`defaultTime?` | [Time](_lumin_.ui.time.md) | `default = Time()`<br/> The default time to set for the TimePicker.  |

**Returns:** *[UiTimePicker](_lumin_.ui.uitimepicker.md)*

The new UiTimePicker node.
