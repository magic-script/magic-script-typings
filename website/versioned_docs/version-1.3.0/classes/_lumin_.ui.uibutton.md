...
## Hierarchy
  ...
  ↳ [UiDropDownList](_lumin_.ui.uidropdownlist.md)
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `labelText`: string, `width?`: number, `height?`: number, `roundness?`: number): *[UiButton](_lumin_.ui.uibutton.md)*
...
`labelText` | string | The UTF-8 encoded text to initially set the UiButton label to. |
`width?` | number | `default = 0.0`<br/> - The width of the button, 0 for default. |
`height?` | number | `default = 0.0`<br/> - The height of the button, 0 for default. |
`roundness?` | number | `default = 1.0`<br/> - The ratio of corner rounding (0-1).  1 [default] = fully rounded (circle, capsule), 0 = sharp corner. |

**Returns:** *[UiButton](_lumin_.ui.uibutton.md)*

The new UiButton node.
