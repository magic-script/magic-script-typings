declare module 'lumin' {
  ...
  class PhysicsRigidBody {
     ...
     * @param [position=VEC3_ZERO] Offset from the body's location to place the shape.
     * @param [rotation=QUAT_IDENTITY] Rotation of the shape relative to the body's orientation.
