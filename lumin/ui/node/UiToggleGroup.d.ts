declare module 'lumin' {
  namespace ui {
    ...
    class UiToggleGroup extends UiNode {
       ...
       * @param [allowMultipleOn=false] - The default (false) does not allow multiple toggles ON.
       * @param [allowAllOff=false] - The default (false) does not allow all toggles OFF.
