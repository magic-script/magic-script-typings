...
Name | Type | Description |
------ | ------ | ------ |
`item` | [UiListViewItem](_lumin_.ui.uilistviewitem.md) | The node hierarchy to add to the list.  |
...
Name | Type | Description |
------ | ------ | ------ |
`item` | [UiListViewItem](_lumin_.ui.uilistviewitem.md) | Pointer to the item Node. |
...
the size of the list view area.
...
Name | Type | Description |
------ | ------ | ------ |
`index` | number | The index of the item you would like to scroll to. |

**Returns:** *boolean*

true if scroll succeeded else false.
...
Name | Type | Description |
------ | ------ | ------ |
`item` | [UiListViewItem](_lumin_.ui.uilistviewitem.md) | The item you would like to scroll to. |
...
Name | Type | Description |
------ | ------ | ------ |
`uiSB` | [UiScrollBar](_lumin_.ui.uiscrollbar.md) | the scrollbar to use for the UiListView.  |
...
Name | Type | Description |
------ | ------ | ------ |
`size` | [number, number] | the size of the list view area.  |
...
`width?` | number | `default = 0.0`<br/> - The width of the list view.  The default (0) allows the list to grow to content. |
`height?` | number | `default = 0.0`<br/> - The height of the list view.  The default (0) allows the list to grow to content. |

**Returns:** *[UiListView](_lumin_.ui.uilistview.md)*

The new UiListView node.
