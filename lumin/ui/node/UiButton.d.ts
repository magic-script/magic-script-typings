declare module 'lumin' {
  namespace ui {
    ...
    class UiButton extends UiNode {
       ...
       * @param [width=0.0] - The width of the button, 0 for default.
       * @param [height=0.0] - The height of the button, 0 for default.
       * @param [roundness=1.0] - The ratio of corner rounding (0-1).  1 [default] = fully rounded (circle, capsule), 0 = sharp corner.
       ...
       * @param [offset=VEC3_ZERO] - An optional offset to position the Node within the UiButton (default is [0,0,0]).
       *
       * @priv none
       */
