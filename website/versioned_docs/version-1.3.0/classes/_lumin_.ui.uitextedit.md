...
▸ **onCharacterEnteredSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
▸ **onKeyboardEventSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
▸ (`arg0`: [UiEventData](_lumin_.ui.uieventdata.md), `arg1`: [EventData](_lumin_.ui.keyboardevent.eventdata.md)): *void*
...
------ | ------ |
`arg0` | [UiEventData](_lumin_.ui.uieventdata.md) |
`arg1` | [EventData](_lumin_.ui.keyboardevent.eventdata.md) |
...
▸ **onTextChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`limit` | number | the maximum number of characters.  |
...
Name | Type | Description |
------ | ------ | ------ |
`str` | string | The text for the hint.  |
...
Name | Type | Description |
------ | ------ | ------ |
`color` | [number, number, number, number] | The color for the hint text. If its alpha value is 0, this color is ignored and the color returned by getTextColor() is used instead.  |
...
Name | Type | Description |
------ | ------ | ------ |
`keyboardProperties` | [KeyboardProperties](_lumin_.ui.keyboardproperties.md) | the structure containing the keyboard properties.  |
...
Name | Type | Description |
------ | ------ | ------ |
`multilineMode` | boolean | the multi-line flag.  |
...
Name | Type | Description |
------ | ------ | ------ |
`passwordMode` | boolean | the password mode flag.  |
...
Name | Type | Description |
------ | ------ | ------ |
`visibilityMode?` | [ScrollBarVisibility](../enums/_lumin_.ui.scrollbarvisibility.md) | `default = ScrollBarVisibility.kAuto`<br/> the visibility mode of the scrollbar.  |
...
Name | Type | Description |
------ | ------ | ------ |
`scrollValue` | number | the normalized value between 0 and 1.   @priv none  |
...
Name | Type | Description |
------ | ------ | ------ |
`scrollingEnabled` | boolean | the enabled flag.  |
...
Name | Type | Description |
------ | ------ | ------ |
`startIndex` | number | the first index for text selection. |
`endIndex` | number | the last index for text selection.  |
...
Name | Type | Description |
------ | ------ | ------ |
`alignment` | [HorizontalTextAlignment](../enums/_lumin_.ui.horizontaltextalignment.md) | One of the values defined in HorizontalTextAlignment.   @priv none  |
...
Name | Type | Description |
------ | ------ | ------ |
`entryMode` | [TextEntryMode](../enums/_lumin_.ui.textentrymode.md) | the new text entry mode.  |
...
`text` | string | The UTF-8 encoded text to initially set the UiTextEdit to. |
`width` | number | The width of the text edit area. |
`height` | number | The height of the text edit area. |
