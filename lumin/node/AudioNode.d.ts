declare module 'lumin' {
  class AudioNode extends TransformNode {
     ...
     * @param [autoDestroy=false] - If true, play the sound once and  delete the node. If false the audio
     *                      node will stay until scenegraph is destroyed.
     *                      It is good practice to remove the unused node sooner than later after
     *                      it's not required.
     * @param [dynamicDecode=false] - true = The file resource is compressed and will be decoded when playing.
     ...
     * @param [autoDestroy=false] - If true, play the sound once and  delete the node. If false the audio node will
     ...
     * @param [autoDestroy=false] Default is false and currently ignored.
     */
     ...
     * @param [oldResourceID=INVALID_RESOURCE_ID] The old resource to be disassociated.
     *
