---
id: "_lumin_.ui.uicircleconfirmation"
title: "UiCircleConfirmation"
sidebar_label: "UiCircleConfirmation"
---
...
###  onConfirmationCanceledSub

▸ **onConfirmationCanceledSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onConfirmationCanceledUnsub

▸ **onConfirmationCanceledUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
###  onConfirmationCompleteSub

▸ **onConfirmationCompleteSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onConfirmationCompleteUnsub

▸ **onConfirmationCompleteUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
###  onConfirmationUpdateSub

▸ **onConfirmationUpdateSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onConfirmationUpdateUnsub

▸ **onConfirmationUpdateUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `height?`: number): *[UiCircleConfirmation](_lumin_.ui.uicircleconfirmation.md)*
...
`height?` | number | `default = 0`<br/> - The radius of the circle the knob evolves at. |

**Returns:** *[UiCircleConfirmation](_lumin_.ui.uicircleconfirmation.md)*

The new UiCircleConfirmation node.
