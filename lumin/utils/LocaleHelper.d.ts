declare module 'lumin' {
  namespace utils {
    ...
    class LocaleHelper {
      ...
      /**
       * Constructor
       * @param [locale="en"] the locale code to initialize the helper with (E.g. "en", "en_US", "es" etc.)
       * @param [path="res"] the path of the icu data file (e.g. "res")
       * @param [file="locale"] the filename of the locale file (the .dat extension is not required)
       */
