---
id: "_lumin_.ui.uiwebview"
title: "UiWebView"
sidebar_label: "UiWebView"
---
...
\+ **new UiWebView**(): *[UiWebView](_lumin_.ui.uiwebview.md)*

**Returns:** *[UiWebView](_lumin_.ui.uiwebview.md)*
...
▸ **getDataManagerInstance**(): *[UiWebViewDataManager](_lumin_.ui.uiwebviewdatamanager.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`url` | string | local or remote web url to load in webview  |
...
Name | Type | Description |
------ | ------ | ------ |
`xpixels` | number | amount of pixels to scroll on x |
`ypixels` | number | amount of pixels to scroll on y  |
...
▸ **setWebViewClient**(`client`: [UiWebViewClient](_lumin_.ui.uiwebviewclient.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`client` | [UiWebViewClient](_lumin_.ui.uiwebviewclient.md) | a pointer to UiWebViewClient instance.  |
...
▸ **Create**(`volume`: [Prism](_lumin_.prism.md), `size`: [number, number]): *[UiWebView](_lumin_.ui.uiwebview.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`volume` | [Prism](_lumin_.prism.md) | The volume to create this UiWebView for. |
`size` | [number, number] | the width and height of the WebView |
