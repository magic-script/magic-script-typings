declare module 'lumin' {
  namespace ui {
    ...
    class UiPageView extends UiNode {
       ...
       * @param [width=0.0] - The width of the page view.  The default (0) allows the view to grow to content.
       * @param [height=0.0] - The height of the page view.  The default (0) allows the view to grow to content.
       ...
       * @param [alignment=Alignment.TOP_LEFT] The page alignment.
       *
       * @priv none
       */
