---
id: "_lumin_.ui.uiimage"
title: "UiImage"
sidebar_label: "UiImage"
---
...
###  getImageFrameResource

▸ **getImageFrameResource**(): *bigint*
...
Name | Type | Description |
------ | ------ | ------ |
`color` | [number, number, number, number] | The color.  |
...
###  setImageFrameResource

▸ **setImageFrameResource**(`resID`: bigint): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`isOpaque` | boolean | The new opacity state of the image.  |
...
Name | Type | Description |
------ | ------ | ------ |
`isUI` | boolean | The new UiLayerRender state of the image.  |
...
▸ **setRenderResource**(`resID`: bigint): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`size` | [number, number] | The image size.  |
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `type`: [SystemIcon](../enums/_lumin_.ui.systemicon.md), `height`: number): *[UiImage](_lumin_.ui.uiimage.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create this image for. |
`type` | [SystemIcon](../enums/_lumin_.ui.systemicon.md) | The SystemIcon type for the image. |
`height` | number | The height of the image. |

**Returns:** *[UiImage](_lumin_.ui.uiimage.md)*

The new UiImage node.

▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `resID`: bigint, `width`: number, `height`: number, `useFrame?`: boolean): *[UiImage](_lumin_.ui.uiimage.md)*
...
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create this image for. |
`resID` | bigint | The resource ID to render for the image. |
`width` | number | The width of the image. |
`height` | number | The height of the image. |
`useFrame?` | boolean | `default = false`<br/> - Specifies whether the image should have a frame. |

**Returns:** *[UiImage](_lumin_.ui.uiimage.md)*

The new UiImage node.

▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `pngFile`: string, `width`: number, `height`: number, `a_absolutePath?`: boolean, `useFrame?`: boolean): *[UiImage](_lumin_.ui.uiimage.md)*
...
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create this image for. |
`pngFile` | string | The path to the PNG to render for the image. |
`width` | number | The width of the image. |
`height` | number | The height of the image. |
...
### `Static` GetSystemIconResource

▸ **GetSystemIconResource**(`prism`: [Prism](_lumin_.prism.md), `icon`: [SystemIcon](../enums/_lumin_.ui.systemicon.md)): *bigint*
...
Name | Type | Description |
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | the prism. |
`icon` | [SystemIcon](../enums/_lumin_.ui.systemicon.md) | the SystemIcon to get the ResourceIdType for.  |
