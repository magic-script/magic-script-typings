declare module 'lumin' {
  namespace ui {
    ...
    class UiPortalIcon extends UiNode {
       ...
       * @param [portalSize=PortalIconSize.kSmall] - One of the built-in sizes for the portal icon (defaults to Small)
       ...
       * @param [offset=VEC3_ZERO] - An optional offset to position the Node within the UiPortalIcon (default is [0,0,0]).
       *
       * @priv none
       */
