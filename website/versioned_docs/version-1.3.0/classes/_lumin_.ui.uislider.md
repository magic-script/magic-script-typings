---
id: "_lumin_.ui.uislider"
title: "UiSlider"
sidebar_label: "UiSlider"
---
...
▸ **detachSliderModel**(): *[Node](_lumin_.node.md)*
...
▸ **getSliderModel**(): *[Node](_lumin_.node.md)*
...
▸ **onSliderChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onSliderChangedUnsub

▸ **onSliderChangedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
▸ **setSliderModel**(`pNode`: [Node](_lumin_.node.md), `offset?`: [number, number, number]): *void*
...
`offset?` | [number, number, number] | `default = VEC3_ZERO`<br/> - An optional offset to position the Node within the UiSlider (default is [0,0,0])  |
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md), `width`: number, `height?`: number): *[UiSlider](_lumin_.ui.uislider.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The voluem to create this slider for. |
`width` | number | The width of the slider. |
`height?` | number | `default = 0.0`<br/> - The height of the slider, 0 for default. |

**Returns:** *[UiSlider](_lumin_.ui.uislider.md)*

The new UiSlider node.

___

### `Static` CreateEclipseSlider

▸ **CreateEclipseSlider**(`prism`: [Prism](_lumin_.prism.md), `sliderParams`: [EclipseSliderParams](_lumin_.ui.eclipsesliderparams.md)): *[UiSlider](_lumin_.ui.uislider.md)*
...
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The voluem to create this slider for. |
`sliderParams` | [EclipseSliderParams](_lumin_.ui.eclipsesliderparams.md) | The EclipseButtonParams describing the Eclipse slider to create. |

**Returns:** *[UiSlider](_lumin_.ui.uislider.md)*

The new UiSlider node representing the Eclipse slider.
