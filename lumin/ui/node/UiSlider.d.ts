declare module 'lumin' {
  namespace ui {
    ...
    class UiSlider extends UiNode {
       ...
       * @param [height=0.0] - The height of the slider, 0 for default.
       ...
       * @param [offset=VEC3_ZERO] - An optional offset to position the Node within the UiSlider (default is [0,0,0])
       *
       * @priv none
       */
