declare module 'lumin' {
  namespace ui {
    ...
    class UiListView extends UiNode {
       ...
       * @param [width=0.0] - The width of the list view.  The default (0) allows the list to grow to content.
       * @param [height=0.0] - The height of the list view.  The default (0) allows the list to grow to content.
