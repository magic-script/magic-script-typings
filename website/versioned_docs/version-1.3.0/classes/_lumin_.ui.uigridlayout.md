...
Name | Type | Description |
------ | ------ | ------ |
`item` | [TransformNode](_lumin_.transformnode.md) | The node hierarchy to add to the grid.  |
...
------ | ------ | ------ |
`item` | [TransformNode](_lumin_.transformnode.md) | The node hierarchy to add to the grid. |
`padding` | [number, number, number, number] | The item padding within the grid.  |
...
Name | Type | Description |
------ | ------ | ------ |
`row` | number | The row position of the item (zero-based). |
`col` | number | The column position of the item (zero-based). |
...
Name | Type | Description |
------ | ------ | ------ |
`columns` | number | the number of columns for the grid layout.  |
...
Name | Type | Description |
------ | ------ | ------ |
`rows` | number | the number of rows for the grid layout.  |
