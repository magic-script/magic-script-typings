declare module 'lumin' {
  namespace ui {
    ...
    class Keyboard {
       ...
       * @priv none
       */
      show(a_pClientVol: Prism, a_pLocaleCode: ui.Locale.Code, a_keyboardProperties: ui.KeyboardProperties, a_eventHandler: (arg0: ui.KeyboardEvent.EventData) => void, positionExtents?: math.AABB): ui.Keyboard.ShowKeyboardReturnCode
       ...
       * @priv none
       */
      onVisibilityChangedSub(callback: (arg0: boolean) => void): utils.CallbackID
