declare module 'lumin' {
  ...
  class BaseApp {
     ...
     * @param [controlID=INVALID_CONTROL_ID] the ID of the control to use (0 will be the primary control)
     * @param [deviceID=INVALID_DEVICE_ID] the internal ID of the device to use (note, this takes precedence over the control ID)
     *
     * @priv none
     */
     ...
     * @param [duration=100] the duration to play the pattern over (ms)
     * @param [intensity=haptics.VibeIntensity.MEDIUM] the intensity of the vibration
     * @param [controlID=INVALID_CONTROL_ID] the ID of the control to use (0 will be the primary control)
     * @param [deviceID=INVALID_DEVICE_ID] the internal ID of the device to use (note, this takes precedence over the control ID)
     *
     * @priv none
     ...
     * @param [duration=100] the duration to play the pattern over (ms)
     * @param [intensity=haptics.VibeIntensity.MEDIUM] the intensity of the haptic
     * @param [controlID=INVALID_CONTROL_ID] the ID of the control to use (0 will be the primary control)
     * @param [deviceID=INVALID_DEVICE_ID] the internal ID of the device to use (note, this takes precedence over the control ID)
     *
     * @priv none
    ...
    * @param [confidenceThreshold=0.199] Confidence level (between 0 and 1) that must be reached for the
    ...
    */
     ...
     * @param [a_hold=false] Whether the event should be sent immediately (true), or send only if the
     *   gesture is held for 1.5 seconds (false).
     * @param [a_once=true] Whether the event should be repeated (true), or send only once (false).
     * @param [a_handIndex=0xFFFFFFFF] Hand index that the event should be associated with
     *   (Left = 0, Right = 1, Both = 0xFFFFFFFF).
     * @return The Id that can be used to identify this event when received in the eventListener.
     */
    addNamedHandGestureAction(a_actionName: string, a_handGesture: input.GestureType, a_hold: boolean = 0 /* 0 is not the actual default value */, a_once: boolean = 0 /* 0 is not the actual default value */, a_handIndex: number = 0 /* 0 is not the actual default value */): number
     ...
     * @param [a_longPress=false] Whether the event should be emitted on long press (true) or short press (false)
     * @return The Id that can be used to identify this event when received in the eventListener
     */
    addNamedButtonAction(a_actionName: string, a_keyCode: input.KeyCodes, a_longPress: boolean = 0 /* 0 is not the actual default value */): number
     ...
     * @param [a_touchDirection=input.GestureDirection.UNKNOWN] Gesture's direction (GestureDirection::UNKNOWN for all).
     * @return The Id that can be used to identify this event when received in the eventListener
     */
    addNamedTouchAction(a_actionName: string, a_touchGesture: input.GestureType, a_touchDirection: input.GestureDirection = 0 /* 0 is not the actual default value */): number
     ...
     * @priv PcfRead
     */
    getPCFs(): Array<PCFId> /* std::vector */
