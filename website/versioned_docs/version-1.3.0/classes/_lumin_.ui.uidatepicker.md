---
id: "_lumin_.ui.uidatepicker"
title: "UiDatePicker"
sidebar_label: "UiDatePicker"
---
...
▸ **onDateChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
▸ (`arg0`: [UiEventData](_lumin_.ui.uieventdata.md), `arg1`: string, `arg2`: [Date](_lumin_.ui.date.md)): *void*
...
▸ **onDateChangedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
▸ **onDateConfirmedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
###  onDateConfirmedUnsub

▸ **onDateConfirmedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
Name | Type | Description |
------ | ------ | ------ |
`color` | [number, number, number, number] | The color to set.  |
...
▸ **setDate**(`date`: [Date](_lumin_.ui.date.md)): *boolean*
...
Name | Type | Description |
------ | ------ | ------ |
`date` | [Date](_lumin_.ui.date.md) | The Date to set, will ignore values that arent in the dateFormat. |

**Returns:** *boolean*

true if its a valid date and it has been set.
...
▸ **Create**(`volume`: [Prism](_lumin_.prism.md), `label?`: string, `labelSide?`: [Side](../enums/_lumin_.ui.side.md), `dateFormat?`: string, `defaultDate?`: [Date](_lumin_.ui.date.md), `yearMin?`: number, `yearMax?`: number): *[UiDatePicker](_lumin_.ui.uidatepicker.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`volume` | [Prism](_lumin_.prism.md) | The volume to create the node for. |
`label?` | string | `default = ""`<br/> The text label that appears with the DatePicker. |
`labelSide?` | [Side](../enums/_lumin_.ui.side.md) | `default = Side.kTop`<br/> Side enum specifying whether the label appears on the side or top. Only top and left currently supported. |
`dateFormat?` | string | `default = "MM/DD/YYYY"`<br/> The format for the picker date - MM/DD/YYYY, DD/MM/YYYY, MM/YYYY, DD/YYYY. |
`defaultDate?` | [Date](_lumin_.ui.date.md) | `default = Date()`<br/> The default date to appear on the picker instead of the placeholder strings. |
`yearMin?` | number | `default = -1`<br/> The minimum year available to choose from. |
`yearMax?` | number | `default = -1`<br/> The maximum year available to choose from.  |

**Returns:** *[UiDatePicker](_lumin_.ui.uidatepicker.md)*

The new UiDatePicker node.
