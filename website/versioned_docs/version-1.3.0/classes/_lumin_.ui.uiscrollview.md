---
id: "_lumin_.ui.uiscrollview"
title: "UiScrollView"
sidebar_label: "UiScrollView"
---
...
▸ **getScrollBar**(`orientation`: [Orientation](../enums/_lumin_.ui.orientation.md)): *[UiScrollBar](_lumin_.ui.uiscrollbar.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`orientation` | [Orientation](../enums/_lumin_.ui.orientation.md) | the orientation (vertical or horizontal) to which the scrollbar is associated. |

**Returns:** *[UiScrollBar](_lumin_.ui.uiscrollbar.md)*

the scrollbar associated to the desired orientation.
...
one of the three available modes: kOff, kAlways or kAuto.

___

###  getScrollBounds

▸ **getScrollBounds**(): *[AABB](_lumin_.math.aabb.md)*
...
the scrolling bounds.

___

###  getScrollContent

▸ **getScrollContent**(): *[TransformNode](_lumin_.transformnode.md)*
...
▸ **getScrollDirection**(): *[ScrollDirection](../enums/_lumin_.ui.scrolldirection.md)*

Gets the scroll direction for the scroll view.

**`priv`** none

**Returns:** *[ScrollDirection](../enums/_lumin_.ui.scrolldirection.md)*

the supported scroll direction.
...
▸ **onScrollChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`mode` | [CursorEdgeScrollMode](../enums/_lumin_.ui.cursoredgescrollmode.md) | the CursorEdgeScrollMode.  |
...
▸ **setScrollBar**(`orientation`: [Orientation](../enums/_lumin_.ui.orientation.md), `uiSB`: [UiScrollBar](_lumin_.ui.uiscrollbar.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`orientation` | [Orientation](../enums/_lumin_.ui.orientation.md) | the orientation (vertical or horizontal) for which the scrollbar is to be set. |
`uiSB` | [UiScrollBar](_lumin_.ui.uiscrollbar.md) | the scrollbar to use for the desired orientation.  |
...
Name | Type | Description |
------ | ------ | ------ |
`visibilityMode` | [ScrollBarVisibility](../enums/_lumin_.ui.scrollbarvisibility.md) | one of three available modes: kOff, kAlways or kAuto.  |
...
▸ **setScrollBounds**(`bounds`: [AABB](_lumin_.math.aabb.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`bounds` | [AABB](_lumin_.math.aabb.md) | The scrolling bounds.  |
...
▸ **setScrollContent**(`pNode`: [TransformNode](_lumin_.transformnode.md), `offset?`: [number, number, number]): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`pNode` | [TransformNode](_lumin_.transformnode.md) | A pointer to the Node. |
`offset?` | [number, number, number] | `default = VEC3_ZERO`<br/> - An optional offset to position the Node (default is [0,0,0]).  |
...
▸ **setScrollDirection**(`direction`: [ScrollDirection](../enums/_lumin_.ui.scrolldirection.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`direction` | [ScrollDirection](../enums/_lumin_.ui.scrolldirection.md) | the supported scroll direction.  |
...
▸ **setScrollMask**(`textureResource`: bigint): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`textureResource` | bigint | the render resource id for the mask node texture.  |
...
▸ **setScrollOffset**(`offset`: [number, number, number]): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`offset` | [number, number, number] | The offset of the scroll content  |
...
Name | Type | Description |
------ | ------ | ------ |
`scrollSpeed` | number | the scroll speed.  |
...
Name | Type | Description |
------ | ------ | ------ |
`value` | number | The normalized position value of the scroll content, between 0 and 1.  |
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md)): *[UiScrollView](_lumin_.ui.uiscrollview.md)*
...
**Returns:** *[UiScrollView](_lumin_.ui.uiscrollview.md)*

New UiScrollView on success; nullptr on failure.
