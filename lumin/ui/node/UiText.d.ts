declare module 'lumin' {
  namespace ui {
    ...
    class UiText extends UiNode {
       ...
       * @param [style=resources.FontStyle.kNormal] The style of the Magic Leap font.
       * @param [weight=resources.FontWeight.kRegular] The weight (i.e., thickness) of the Magic Leap font.
       ...
       * @param [params=[]] The localization parameters.
       * @return The new UiText node.
       *
       * @priv none
       */
       ...
       * @param [wrap=true] to wrap the text within the bounds or truncate
       *
       * @priv none
       */
