---
id: "_lumin_.ui.uirectlayout"
title: "UiRectLayout"
sidebar_label: "UiRectLayout"
---
...
▸ **detachContent**(): *[TransformNode](_lumin_.transformnode.md)*
...
▸ **getContent**(): *[TransformNode](_lumin_.transformnode.md)*
...
a pointer to the content node.

___

###  getContentAlignment

▸ **getContentAlignment**(): *[Alignment](_lumin_.ui.alignment.md)*
...
▸ **setContent**(`pNode`: [TransformNode](_lumin_.transformnode.md)): *void*
...
▸ **setContentAlignment**(`alignment`: [Alignment](_lumin_.ui.alignment.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`alignment` | [Alignment](_lumin_.ui.alignment.md) | Content alignment.  |
...
▸ **Create**(`prism`: [Prism](_lumin_.prism.md)): *[UiRectLayout](_lumin_.ui.uirectlayout.md)*
...
**Returns:** *[UiRectLayout](_lumin_.ui.uirectlayout.md)*

New UiRectLayout on success; nullptr on failure.
