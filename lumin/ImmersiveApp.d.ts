declare module 'lumin' {
  ...
  class ImmersiveApp extends BaseApp {
     ...
     *
     * @param [a_fTimeDelta=0.0] - the preferred update rate as a time interval in seconds.
     ...
     * @param [a_ePrismType=PrismType.kWorld] - Type of Prism (eg: Tied to Headpose or Fixed in the world)
