...
▸ **addPage**(`page`: [TransformNode](_lumin_.transformnode.md)): *void*
...
Name | Type | Description |
------ | ------ | ------ |
`page` | [TransformNode](_lumin_.transformnode.md) | The node hierarchy to add to the view.  |
...
------ | ------ | ------ |
`page` | [TransformNode](_lumin_.transformnode.md) | The node hierarchy to add to the view. |
`padding` | [number, number, number, number] | The page padding within the view. |
`alignment?` | [Alignment](_lumin_.ui.alignment.md) | `default = Alignment.TOP_LEFT`<br/> The page alignment.  |
...
Name | Type | Description |
------ | ------ | ------ |
`index` | number | The index of the page in the view. |
...
Name | Type | Description |
------ | ------ | ------ |
`page` | [TransformNode](_lumin_.transformnode.md) | Pointer to the page Node. |
...
the size of the page view area.
...
Name | Type | Description |
------ | ------ | ------ |
`alignment` | [Alignment](_lumin_.ui.alignment.md) | The default page alignment.  |
...
------ | ------ | ------ |
`index` | number | The index of the page in the view. |
`alignment` | [Alignment](_lumin_.ui.alignment.md) | The page alignment.  |
...
------ | ------ | ------ |
`index` | number | The index of the page in the view. |
`padding` | [number, number, number, number] | The page padding.  |
...
Name | Type | Description |
------ | ------ | ------ |
`size` | [number, number] | the size of the page view area.  |
...
Name | Type | Description |
------ | ------ | ------ |
`page` | [TransformNode](_lumin_.transformnode.md) | The page to display.  |
...
`width?` | number | `default = 0.0`<br/> - The width of the page view.  The default (0) allows the view to grow to content. |
`height?` | number | `default = 0.0`<br/> - The height of the page view.  The default (0) allows the view to grow to content. |

**Returns:** *[UiPageView](_lumin_.ui.uipageview.md)*

The new UiPageView node.
