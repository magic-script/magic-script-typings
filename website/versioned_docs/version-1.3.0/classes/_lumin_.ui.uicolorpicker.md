...
▸ (`arg0`: [UiEventData](_lumin_.ui.uieventdata.md), `arg1`: [number, number, number, number]): *void*
...
▸ **onColorChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
Name | Type | Description |
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create the node for. |
`startingColor?` | [number, number, number, number] | `default = VEC4_ONE`<br/> The initial color for the color picker. |
`height?` | number | `default = 0.0`<br/> Optional height for the color picker.  |

**Returns:** *[UiColorPicker](_lumin_.ui.uicolorpicker.md)*

The new UiColorPicker node.
