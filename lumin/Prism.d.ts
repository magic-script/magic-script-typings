declare module 'lumin' {
  ...
  class Prism {
     ...
     *
     * @param [a_width=512] - The surface initial resolution width 1 to 2048 (will be overwritten by video resolution)
     * @param [a_height=512] - The surface initial resolution height 1 to 2048 (will be overwritten by video resolution)
     ...
     * @param [style=resources.FontStyle.kNormal] Either normal or italic style are supported.
     ...
     * @param [a_data=null] Optional data used to initialize the simulation. Ignored if a_enable = false.
     */
     ...
     * @param [a_localScopeOnly=false] The scope of this material. When set to true the kmat's contained in the material
     *                     will not be added to the prism's list of materials for general resolve.
     * @param [a_absolutePath=false] Flag that a_fFileName is an absolute path name, instead of a relative path.
     * @param [a_descriptor=-1] - optional file descriptor that points to a resource.
     *                     If passed to the resource the resource takes ownership of the File Descriptor.
     * @param [a_basePath=null] - If you are loading a resource from an absolute path, and that path !=
     ...
     */
    createMaterialResourceId(a_fileName: string, a_localScopeOnly: boolean = 0 /* 0 is not the actual default value */, a_absolutePath: boolean = 0 /* 0 is not the actual default value */, a_descriptor: number = 0 /* 0 is not the actual default value */, a_basePath: string = 0 /* 0 is not the actual default value */): BigInt /* uint64_t */
     ...
     * @param [a_absolutePath=false] Flag that a_fileName is an absolute path name, instead of a relative path.
     * @param [a_descriptor=-1] - optional file descriptor that points to a resource.
     *                     If passed to the resource the resource takes ownership of the File Descriptor.
     * @param [a_basePath=null] - If you are loading a resource from an absolute path, and that path !=
     *                     The current process path, set this field to the equivalent base path in the other
     ...
     *                     qualified (absolute) path outside of the current process. This value defaults to
     *                     the currently executing process root.
     * @param [a_materialScopeId=INVALID_RESOURCE_ID] Optional MaterialResouce. When set the new ModelResoure will only use KMATs that
     ...
     * @param [a_forceMaterialScope=false] When optionally set the new ModelResource will only attempt to resolve KMAT's
     *                     from embedded materials, or when a_materialScopeId also from that MaterialResource.
     *
     * @return ID for the Resource
     */
    createModelResourceId(a_fileName: string, a_importScale: number, a_absolutePath: boolean = 0 /* 0 is not the actual default value */, a_descriptor: number = 0 /* 0 is not the actual default value */, a_basePath: string = 0 /* 0 is not the actual default value */, a_materialScopeId: BigInt /* uint64_t */ = 0 /* 0 is not the actual default value */, a_forceMaterialScope: boolean = 0 /* 0 is not the actual default value */): BigInt /* uint64_t */
     ...
     *
     * @param [a_width=512] - The Width 1 to 2048
     * @param [a_height=512] - The Height 1 to 2048
     ...
     *  from the executable file.
     * @param [a_absolutePath=false] Flag that pngFile is an absolute path name, instead of a relative path.
     * @param [a_fileDescriptor=-1] - optional file descriptor that points to a png resource.
     *        If passed to the resource the resource takes ownership of the File Descriptor.
    ...
    */
    createTextureResourceId(tex2dDesc: Desc2d, image: Object): BigInt /* uint64_t */
     ...
     * @param [absolutePath=false] flag that the location is an absolute path instead of a relative path.
     ...
     *
     * @param image Decoded Image data to be used for rendering.
     * @param [desc=Desc3d.DEFAULT] Optional Initialization parameters for the resource to control rendering.
     ...
     * @param [a_absolutePath=false] Flag that fontFile is an absolute path name, instead of a relative path.
     ...
     * @param objectModelName The name of the object model.
     * @param [objectName=""] The name of an object in the object model. A node tree will be created using this node and its descendants. If empty, the first object in the object model is used.
     ...
     */
    createImage2d(format: utils.Format, width: number, height: number): Object
