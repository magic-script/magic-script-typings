...
▸ **detachToggleModel**(): *[Node](_lumin_.node.md)*
...
true if the toggle is ON, false if not.
...
▸ **onToggleChangedSub**(`callback`: function): *[CallbackID](_lumin_.utils.callbackid.md)*
...
▸ **onToggleChangedUnsub**(`callbackID`: [CallbackID](_lumin_.utils.callbackid.md)): *boolean*
...
Name | Type | Description |
------ | ------ | ------ |
`state` | boolean | the ON (true/false) state of the toggle.  |
...
Name | Type | Description |
------ | ------ | ------ |
`text` | string | Text to set for the toggle label.  |
...
Name | Type | Description |
------ | ------ | ------ |
`rgba` | [number, number, number, number] | Toggle label color.  |
...
`offset?` | [number, number, number] | `default = VEC3_ZERO`<br/> - An optional offset to position the Node within the UiToggle (default is [0,0,0]).  |
...
Name | Type | Description |
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create the toggle for. |
`labelText` | string | The UTF-8 encoded text to initially set the UiToggle label to. |
`height?` | number | `default = 0.0`<br/> - The height of the toggle, 0 for default. |

**Returns:** *[UiToggle](_lumin_.ui.uitoggle.md)*

The new UiToggle node.
...
`prism` | [Prism](_lumin_.prism.md) | The prism to create the toggle for. |
`labelText` | string | The UTF-8 encoded text to initially set the UiToggle label to. |
`toggleType` | [ToggleType](../enums/_lumin_.ui.toggletype.md) | The type of the toggle (kDefault, kRadio, kCheckbox). |
`height?` | number | `default = 0.0`<br/> - The height of the toggle, 0 for default. |
...
------ | ------ | ------ |
`prism` | [Prism](_lumin_.prism.md) | The prism to create the toggle for. |
`toggleParams` | [EclipseToggleParams](_lumin_.ui.eclipsetoggleparams.md) | The EclipseToggleParams describing the Eclipse toggle to create. |

**Returns:** *[UiToggle](_lumin_.ui.uitoggle.md)*

The new UiToggle node representing the Eclipse toggle.
